...
import GridHistorico from './GridHistorico';
import { showAnimal, getAnimais } from '../../services/api';

const HistoricoInternamento = () => {
    ...
    return (
        <div>
            <div className="headerHistInternamento">
                <h2>Históricos de Internamento</h2>
            ...
            <div className="main-container">
                ...
                <div className="animal-content">
                    {animalData.map((element) => {
                        return (
                            <div>
                                <div className="animalHistInternamento-information">
                                ...
                                <h2>Históricos de Internamento</h2>
                                <GridHistorico animalID={element.Ani_Codigo}/>
                                <br/>
                                <br/>
                            </div>
                        )
...
export default HistoricoInternamento;